...
.rsvp-input:focus { border-color: #C9A96E !important; outline: none; }
    ...
    <section style={{ position:"relative", height:"100vh", minHeight:580, overflow:"hidden" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          Manan
          <span style={{ color:"#C9A96E", display:"block" }}>&amp; Shrishti</span>
        </div>
        <div style={{
        ...
        <a
          ...
          style={{
            ...
            background:"#C9A96E", color:"#1E2A4A",
  ...
  return (
    <section ref={ref} style={{
      ...
      <div style={{
        ...
        <span style={{
          fontSize:"clamp(36px,10vw,56px)", display:"inline-block",
          opacity: visible ? 1 : 0,
      ...
      <p style={{
        ...
        maxWidth:480, margin:"0 auto 32px", fontWeight:300,
        opacity: visible ? 1 : 0,
      ...
      <div style={{
        height:1, background:"linear-gradient(to right, transparent, #C9A96E, transparent)",
...
function StoryMoment({ moment, index }) {
  ...
  return (
    <div ref={ref} style={{
      ...
      gap:24, marginBottom:56, alignItems:"flex-start",
    }}>
      <div style={{
        flex:"0 0 140px",
        opacity: visible ? 1 : 0,
        ...
        <div style={{ width:140, height:180, borderRadius:16, overflow:"hidden", boxShadow:"0 8px 32px rgba(30,42,74,0.12)" }}>
          <img src={moment.photo} alt={moment.title} style={{ width:"100%", height:"100%", objectFit:"cover", objectPosition:"top" }}/>
        </div>
      </div>
      <div style={{
        ...
        <div style={{ fontSize:10, letterSpacing:3, textTransform:"uppercase", color:T.gold, marginBottom:6 }}>
          {moment.label}
        </div>
        <div style={{ fontFamily:"'Clash Display',sans-serif", fontSize:18, fontWeight:700, color:T.navy, marginBottom:10 }}>
          {moment.title}
        </div>
        <p style={{ fontSize:13, color:T.muted, lineHeight:1.8, fontWeight:300 }}>{moment.text}</p>
        <div style={{ width:8, height:8, borderRadius:"50%", background:T.gold, marginTop:16, marginLeft: isLeft ? 0 : "auto" }}/>
      </div>
    </div>
  );
}
...
function Story() {
  const moments = [
    { photo:PHOTO_NEW1,  label:"Where it began",      title:"ISB, Hyderabad",              align:"left",  text:"A dance performance. Two strangers. One glance that changed everything. They didn't know it then — but this was the beginning." },
    { photo:PHOTO_FUN,   label:"The moment we knew",  title:"Kasauli, under a shooting star", align:"right", text:"Under an open sky in Kasauli, Manan got down on one knee. A shooting star passed. She said yes before it disappeared." },
    { photo:PHOTO_NEW2,  label:"Making it official",  title:"Diwali, with family",          align:"left",  text:"On the night of a thousand lights, they told their families. The celebration had already begun." },
    { photo:PHOTO_FORMAL,label:"The Roka",            title:"February 2026",               align:"right", text:"Two families became one. Blessings were exchanged, promises were made, and the countdown to September began." },
  ];
  return (
    <section style={{ background:T.white, padding:"72px 0" }}>
      <div style={{ textAlign:"center", marginBottom:56, padding:"0 24px" }}>
        <div style={{ fontSize:11, letterSpacing:4, textTransform:"uppercase", color:T.gold, marginBottom:12 }}>Our Journey</div>
        <h2 style={{ fontFamily:"'Clash Display',sans-serif", fontSize:"clamp(28px,6vw,44px)", fontWeight:700, color:T.navy }}>
          How we got here
        </h2>
      </div>
      <div style={{ maxWidth:680, margin:"0 auto", padding:"0 20px" }}>
        {moments.map((m, i) => <StoryMoment key={i} moment={m} index={i} />)}
      </div>
    </section>
  );
}
  ...
  return (
    ...
    >
      <div style={{
        ...
        <div>
          <div style={{ fontFamily:"'Clash Display',sans-serif", fontSize:20, fontWeight:700, color:T.white }}>{day.day}</div>
          <div style={{ fontSize:12, color:"rgba(255,255,255,0.6)", marginTop:2 }}>{day.date}</div>
        </div>
      </div>
      <div style={{ padding:"20px 24px", display:"flex", flexDirection:"column", gap:16 }}>
        {day.functions.map((fn, fi) => (
          <div key={fi} style={{
            ...
            <div style={{ width:4, height:4, borderRadius:"50%", background:day.color, flexShrink:0, marginTop:7 }}/>
            <div style={{ flex:1 }}>
              <div style={{ fontFamily:"'Clash Display',sans-serif", fontSize:16, fontWeight:600, color:T.navy }}>{fn.name}</div>
      ...
      <div style={{ padding:"0 24px 20px" }}>
        <div style={{
          ...
          background:T.cream, borderRadius:100, padding:"6px 14px", fontSize:12, color:T.muted,
        }}>📍 Vivan Venue, Karnal</div>
      </div>
    </div>
  );
}
...
function Events() {
  ...
  const events = [
    {
      day:"Day 1", date:"Saturday, 20 September 2026", color:T.rose, icon:"🌸",
      functions:[
    ...
    {
      day:"Day 2", date:"Sunday, 21 September 2026", color:T.gold, icon:"✨",
      functions:[
    ...
    <section ref={ref} style={{ padding:"72px 24px", background:T.cream }}>
      <div style={{ textAlign:"center", marginBottom:48 }}>
        <div style={{ fontSize:11, letterSpacing:4, textTransform:"uppercase", color:T.gold, marginBottom:12,
          opacity:visible?1:0, animation:visible?"fadeUp 0.7s ease both":"none" }}>The Celebrations</div>
        <h2 style={{ fontFamily:"'Clash Display',sans-serif", fontSize:"clamp(28px,6vw,44px)", fontWeight:700, color:T.navy,
          opacity:visible?1:0, animation:visible?"fadeUp 0.7s 0.1s ease both":"none" }}>Two days of joy</h2>
  ...
  return (
    <section id="rsvp" ref={ref} style={{ padding:"72px 24px 80px", background:T.white }}>
      <div style={{ textAlign:"center", marginBottom:40 }}>
        <div style={{ fontSize:11, letterSpacing:4, textTransform:"uppercase", color:T.gold, marginBottom:12,
          opacity:visible?1:0, animation:visible?"fadeUp 0.7s ease both":"none" }}>You're invited</div>
        <h2 style={{ fontFamily:"'Clash Display',sans-serif", fontSize:"clamp(28px,6vw,44px)", fontWeight:700, color:T.navy, marginBottom:12,
          opacity:visible?1:0, animation:visible?"fadeUp 0.7s 0.1s ease both":"none" }}>RSVP</h2>
        <p style={{ fontSize:14, color:T.muted, maxWidth:400, margin:"0 auto",
          opacity:visible?1:0, animation:visible?"fadeUp 0.7s 0.2s ease both":"none" }}>
      ...
      {status === "done" ? (
        <div style={{
          ...
          <div style={{ fontFamily:"'Clash Display',sans-serif", fontSize:24, fontWeight:700, color:T.navy, marginBottom:8 }}>
            We can't wait to see you!
          </div>
          <p style={{ color:T.muted, fontSize:14, lineHeight:1.7 }}>
            Your RSVP has been received. We'll be in touch with more details closer to the date. See you in Karnal! 🎉
          </p>
        </div>
      ) : (
        <div style={{
          ...
          <div style={{ marginBottom:14 }}>
            <label style={{ fontSize:12, fontWeight:600, color:T.navy, display:"block", marginBottom:6 }}>Your name *</label>
            <input className="rsvp-input" style={inputStyle} placeholder="Full name"
              value={form.name} onChange={e => setForm(f => ({...f, name:e.target.value}))}/>
          </div>

          <div style={{ marginBottom:14 }}>
            <label style={{ fontSize:12, fontWeight:600, color:T.navy, display:"block", marginBottom:6 }}>Phone number *</label>
              ...
              {EVENT_OPTIONS.map(ev => {
                ...
                return (
                  <div key={ev} onClick={() => toggleEvent(ev)} style={{
                    ...
                    <span style={{ fontSize:13, color: checked ? T.navy : T.muted }}>{ev}</span>
                  </div>
                );
              })}
            </div>
          ...
          <div style={{ marginBottom:24 }}>
            ...
            <textarea className="rsvp-input" style={{...inputStyle, resize:"none", minHeight:80}}
              placeholder="Write something warm ✨" rows={3}
...
function Footer() {
  return (
    <footer style={{ background:T.navy, padding:"40px 24px 32px", textAlign:"center" }}>
      <div className="gold-shimmer" style={{ fontFamily:"'Clash Display',sans-serif", fontSize:32, fontWeight:700, marginBottom:8 }}>
        M &amp; S
      </div>
      <div style={{ color:"rgba(255,255,255,0.5)", fontSize:13, marginBottom:6 }}>September 20 – 21, 2026</div>
      <div style={{ color:"rgba(255,255,255,0.35)", fontSize:12 }}>Vivan Venue · Karnal, Haryana</div>
      <div style={{ marginTop:28, paddingTop:20, borderTop:"1px solid rgba(255,255,255,0.1)", color:"rgba(255,255,255,0.25)", fontSize:11 }}>
